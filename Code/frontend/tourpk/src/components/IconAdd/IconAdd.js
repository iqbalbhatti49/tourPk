...
export default function IconAdd() {
    return (
        <svg id={styles.addIcon} width="40px" height="40px" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" >
        <g id="Page-1" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
          <g id="Add-Stroke">
            ...
            <line x1="12" y1="9" x2="12" y2="15" id="Path" style={{ stroke: '#004346' }} strokeWidth="2" strokeLinecap="round"></line>
