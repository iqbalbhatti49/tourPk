...
const { addRestaurant, getRestaurantById, getAllRestaurants, deleteRestaurant, updaterestaurant, searchRestaurant } = require("../controllers/restaurant.js");

router.post("/addRestaurant", addRestaurant);
router.get("/restaurantListing/:id", getRestaurantById);
router.get("/getRestaurants", getAllRestaurants);
router.get("/searchRestaurant/:searchkey", searchRestaurant);
